...
Este projeto aplica conceitos de **Engenharia de Dados** e **Arquitetura de Medalhão (Medallion Architecture)** para analisar um conjunto histórico de dados sobre acidentes de aviação. O objetivo é transformar dados brutos em um Power BI informativo.

Desenvolvido como parte da disciplina de **Sistemas de Banco de Dados 2** na Universidade de Brasília (UnB).
